...
public final class ToolAbstractEntityCodec extends AbstractEntityCodec<Tool> {
    ...
    public ToolAbstractEntityCodec() {
    }
    ...
    public JsonObject toJson(Tool tool) {
        ...
        if (tool.title() != null) {
            b.add("title", tool.title());
        }
        if (tool.description() != null) {
            b.add("description", tool.description());
        }
        if (tool.outputSchema() != null) {
            b.add("outputSchema", tool.outputSchema());
        }
        if (tool.annotations() != null) {
            b.add("annotations", TOOL_ANNOTATIONS_JSON_CODEC.toJson(tool.annotations()));
        }
        if (tool._meta() != null) {
            b.add("_meta", tool._meta());
        }
        return b.build();
    }
    ...
    public Tool fromJson(JsonObject obj) {
        ...
        if (inputSchema == null) {
            throw new IllegalArgumentException("inputSchema required");
        }
