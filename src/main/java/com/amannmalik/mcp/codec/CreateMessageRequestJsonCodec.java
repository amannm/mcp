...
public class CreateMessageRequestJsonCodec implements JsonCodec<CreateMessageRequest> {
    ...
    public CreateMessageRequestJsonCodec() {
    }
    ...
    public JsonObject toJson(CreateMessageRequest req) {
        ...
        if (req.modelPreferences() != null) {
            b.add("modelPreferences", MODEL_PREFERENCES_JSON_CODEC.toJson(req.modelPreferences()));
        }
        if (req.systemPrompt() != null) {
            b.add("systemPrompt", req.systemPrompt());
        }
        if (req.includeContext() != null) {
            b.add("includeContext", switch (req.includeContext()) {
                case NONE -> "none";
        ...
        if (req.temperature() != null) {
            b.add("temperature", req.temperature());
        }
    ...
    public CreateMessageRequest fromJson(JsonObject obj) {
        ...
        if (!obj.containsKey("maxTokens")) {
            throw new IllegalArgumentException("maxTokens required");
        }
