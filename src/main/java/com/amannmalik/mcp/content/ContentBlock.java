    ...
    JsonCodec<ContentBlock> CODEC = new JsonCodec<>() {
        ...
        public JsonObject toJson(ContentBlock content) {
            ...
            switch (content) {
                ...
                case EmbeddedResource r -> b.add("resource", ResourcesCodec.toJsonObject(r.resource()));
            }
            return b.build();
        }
        ...
        public ContentBlock fromJson(JsonObject obj) {
            ...
            return switch (type) {
                case "text" -> new Text(obj.getString("text"),
                        obj.containsKey("annotations") ? Annotations.CODEC.fromJson(obj.getJsonObject("annotations")) : null,
                        obj.getJsonObject("_meta"));
                case "image" -> new Image(Base64Util.decode(obj.getString("data")),
                        obj.getString("mimeType"),
                        obj.containsKey("annotations") ? Annotations.CODEC.fromJson(obj.getJsonObject("annotations")) : null,
                        obj.getJsonObject("_meta"));
                case "audio" -> new Audio(Base64Util.decode(obj.getString("data")),
                        obj.getString("mimeType"),
                        obj.containsKey("annotations") ? Annotations.CODEC.fromJson(obj.getJsonObject("annotations")) : null,
                        obj.getJsonObject("_meta"));
