...
public final class McpServer implements AutoCloseable {
    ...
    public McpServer(Transport transport, String instructions) {
        this(McpDefaults.resources(), McpDefaults.tools(), McpDefaults.prompts(), McpDefaults.completions(),
                McpDefaults.privacyBoundary("default"),
                McpDefaults.toolAccess(),
                McpDefaults.samplingAccess(),
