...
public final class PerformanceSteps {
    ...
    private final Map<String, Object> historicalBaselines = new HashMap<>();
    private final Map<String, Object> currentPerformance = new HashMap<>();
    private final List<String> performanceRegressions = new ArrayList<>();
