...
- OAuth 2.1 IETF DRAFT ([draft-ietf-oauth-v2-1-13](draft-ietf-oauth-v2-1-13.html))
...
A protected _MCP server_ acts as an [OAuth 2.1 resource server](draft-ietf-oauth-v2-1-13.html#name-roles),
capable of accepting and responding to protected resource requests using access tokens.

An _MCP client_ acts as an [OAuth 2.1 client](draft-ietf-oauth-v2-1-13.html#name-roles),
...
For public clients, authorization servers **MUST** rotate refresh tokens as described in [OAuth 2.1 Section 4.3.1 "Refresh Token Grant"](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-1-13#section-4.3.1).
...
Authorization servers **MUST** take precautions to prevent redirecting user agents to untrusted URI's, following suggestions laid out in [OAuth 2.1 Section 7.12.2](draft-ietf-oauth-v2-1-13.html#section-7.12.2)
...
A MCP server **MUST** follow the guidelines in [OAuth 2.1 - Section 5.2](draft-ietf-oauth-v2-1-13.html#section-5.2) to validate inbound tokens.
