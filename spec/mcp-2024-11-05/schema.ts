...
export interface Result {
    /**
     * This result property is reserved by the endpoint to allow clients and servers to attach additional metadata to their responses.
     */
    _meta?: { [key: string]: unknown };
...
export interface ReadResourceRequest extends Request {
    ...
    params: {
        /**
         * The URI of the resource to read. The URI can use any endpoint; it is up to the server how to interpret it.
         *
         * @format uri
         */
        uri: string;
...
export interface SubscribeRequest extends Request {
    ...
    params: {
        /**
         * The URI of the resource to subscribe to. The URI can use any endpoint; it is up to the server how to interpret it.
         *
         * @format uri
         */
        uri: string;
 ...
 * object, with `isError` set to true, _not_ as an MCP endpoint-level error
...
export interface Root {
     ...
     * This restriction may be relaxed in future versions of the endpoint to allow
     * other URI schemes.
     *
     * @format uri
     */
